function start(){
	var description = "You find yourself located in a desert alone. All you have is water and some leftover food. Type a direction or click a button below. Type help for instructions.";
	return description;	
}
...
function ending(){
	var description = "The villagers have prepared a feast for everyone's return. You may not be home but this can be home for now. THE END!";
	return description;
}
